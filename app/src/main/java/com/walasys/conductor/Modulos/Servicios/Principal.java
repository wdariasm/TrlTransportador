...
import com.walasys.conductor.Fragments.frg_ubicacion_servicio;
...
import com.walasys.conductor.Utiles.ViewPagerAdapter;
import com.walasys.conductor.Utiles.Notificaciones.MyFirebaseInstanceIDService;
...
public class Principal extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MyFirebaseInstanceIDService(this).onTokenRefresh();
