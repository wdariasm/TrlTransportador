package com.walasys.trasnportador.Utiles;
...
import com.walasys.trasnportador.Modulos.Configuracion.Configuracion;
import com.walasys.trasnportador.Modulos.Inicial.Login;
import com.walasys.trasnportador.Modulos.Servicios.Historial;
import com.walasys.trasnportador.Modulos.Servicios.Pagos;
...
import com.walasys.trasnportador.Servicios.webServicesLogin;
...
public class General {
    ...
    public String cargarServidor(){
        SharedPreferences prefs = context.getSharedPreferences("tlrConductor", Context.MODE_PRIVATE);
        return prefs.getString("rutaServidor", "http://app.trlexpress.com.co/public/api");
    }
